...
void FManipulatorPluginStyle::Shutdown()
{
...
FName FManipulatorPluginStyle::GetStyleSetName()
{
	static FName StyleSetName(TEXT("ManipulatorPluginStyle"));
	return StyleSetName;
}
...
void FManipulatorPluginStyle::ReloadTextures()
{
